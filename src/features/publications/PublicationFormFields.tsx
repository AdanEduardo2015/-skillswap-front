      ...
      <Box mb={4}>
        ...
        {(localTagError || errors.tags) ? (
          ...
          <Text fontSize="xs" color="var(--text-muted)" mt={1.5}>
            Presiona <chakra.kbd px={1.5} py={0.5} borderRadius="md" bg="transparent" border="1px solid currentColor" color="inherit" fontSize="10px">Enter</chakra.kbd>, <chakra.kbd px={1.5} py={0.5} borderRadius="md" bg="transparent" border="1px solid currentColor" color="inherit" fontSize="10px">,</chakra.kbd> o espacio para agregar cada etiqueta.
          </Text>
        )}
      </Box>
    </>
